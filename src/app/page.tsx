  ...
  return (
    ...
    >
      ...
      >
        ...
        <ScrambleText>Firmandhani Setyo</ScrambleText>
        ...
        <p className="max-w-lg text-center text-sm dark:text-white md:max-w-2xl md:text-left md:text-base">
          I am a <b>IT Enthusiast</b> from Indonesia, I have a strong
          understanding of programming languages and have experience in{' '}
          <b>Mobile,Web Developer, Network Engineer, System Administrator</b> projects.
        </p>
